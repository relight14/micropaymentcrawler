...
- **AI Query Refinement**: Integrates Claude AI to synthesize conversation history (12 messages x 400 chars) into targeted research queries, enhancing search relevance with intent detection (academic/business/news) for domain filtering.
