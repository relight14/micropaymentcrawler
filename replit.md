...
- **Tiered Research Reports**: The `report_generator.py` service generates AI-powered research reports (executive summaries to comprehensive analyst reports) using Claude with numbered citation format [1], [2], [3]. Includes in-memory caching to optimize API costs and citation metadata extraction for inline purchase badges.
