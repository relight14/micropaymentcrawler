...
from app.api.routes import auth, research, purchase, chat, sources, health, wallet, projects, files, rsl
...
def create_app() -> FastAPI:
    ...
    app.include_router(rsl.router, prefix="/api/rsl", tags=["rsl"])  # RSL licensing
